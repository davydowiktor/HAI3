...
```
gts.hai3.mfe.entry.v1~ (Base - Abstract Contract)
  |-- id: string (GTS type ID)
  |-- requiredProperties: x-gts-ref[] -> gts.hai3.mfe.shared_property.v1~*
  |-- optionalProperties?: x-gts-ref[] -> gts.hai3.mfe.shared_property.v1~*
  |-- actions: x-gts-ref[] -> gts.hai3.mfe.action.v1~*
  |-- domainActions: x-gts-ref[] -> gts.hai3.mfe.action.v1~*
  |
  +-- gts.hai3.mfe.entry.v1~hai3.mfe.entry_mf.v1~ (HAI3 Default - Module Federation)
  |     |-- (inherits contract fields from base)
  |     |-- manifest: x-gts-ref -> gts.hai3.mfe.manifest.v1~*
  |     |-- exposedModule: string
  |
  +-- gts.hai3.mfe.entry.v1~<company>.<package>.mfe.entry_<name>.v1~ (Company Custom)
        |-- (inherits contract fields from base)
        |-- (company-specific loader fields: manifest, exposedModule, etc.)
        |-- (company-specific metadata: translations, routes, preloadAssets, etc.)

gts.hai3.mfe.manifest.v1~ (Standalone - Module Federation Config)
  |-- id: string (GTS type ID)
  ...
  |-- entries?: x-gts-ref[] -> gts.hai3.mfe.entry.v1~hai3.mfe.entry_mf.v1~*
```
...
// gts.hai3.mfe.entry.v1~acme.corp.mfe.entry_acme.v1~
```
 ...
 * GTS Type: gts.hai3.mfe.entry.v1~
 */
interface MfeEntry {
...
const chartEntry: MfeEntryMF = {
  id: 'gts.hai3.mfe.entry.v1~hai3.mfe.entry_mf.v1~acme.analytics.mfe.chart.v1',
  requiredProperties: [
    'gts.hai3.mfe.shared_property.v1~hai3.mfe.props.user_context.v1',
    'gts.hai3.mfe.shared_property.v1~hai3.mfe.props.selected_date_range.v1',
  ],
  optionalProperties: [
    'gts.hai3.mfe.shared_property.v1~hai3.mfe.props.theme.v1',
  ],
  actions: ['gts.hai3.mfe.action.v1~acme.analytics.ext.data_updated.v1'],
  domainActions: ['gts.hai3.mfe.action.v1~acme.analytics.ext.refresh.v1'],
  manifest: 'gts.hai3.mfe.manifest.v1~acme.analytics.mfe.manifest.v1',
