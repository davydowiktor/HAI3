...
describe('AbortSignal support in RestProtocol', () => {
  ...
  it('rejects when the AbortSignal is aborted before the request completes', async () => {
    // @cpt-begin:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-cancel-throws
    ...
    // @cpt-end:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-cancel-throws
  });
  ...
  it('does NOT call onError plugins when the request is canceled', async () => {
    // @cpt-begin:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-cancel-skip-onerror
    const controller = new AbortController();
    const protocol = makeProtocol();
    ...
    // @cpt-end:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-cancel-skip-onerror
  });
  ...
  it('does NOT invoke retry logic from onError plugins when the request is canceled', async () => {
    // @cpt-begin:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-cancel-no-retry
    const controller = new AbortController();
    const protocol = makeProtocol();
    ...
    // @cpt-end:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-cancel-no-retry
  });
  ...
  it('returns mock data from RestMockPlugin even when signal is provided', async () => {
    // @cpt-begin:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-short-circuit-with-signal
    const controller = new AbortController();
    const protocol = makeProtocol();
    ...
    // @cpt-end:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-short-circuit-with-signal
  });
  ...
  it('works correctly when no signal option is provided', async () => {
    // @cpt-begin:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-backward-compat
    const protocol = makeProtocol();
    ...
    // @cpt-end:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-backward-compat
  });
  ...
  it('passes the AbortSignal through to the plugin onRequest context', async () => {
    // @cpt-begin:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-signal-in-context
    const controller = new AbortController();
    const protocol = makeProtocol();
    ...
    // @cpt-end:cpt-hai3-dod-request-lifecycle-abort-signal:p1:inst-test-signal-in-context
  });
