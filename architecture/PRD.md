...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-flat-packages`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-state-interface`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-sdk-flux-terminology`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-screensets-package`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-api-package`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-i18n-package`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-framework-layer`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-action-pattern`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-plugin-arch`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-sdk-react-layer`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sdk-layer-deps`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-sdk-module-augmentation`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-appconfig-tenant`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-appconfig-event-api`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-appconfig-router-config`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-appconfig-layout-visibility`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sse-protocol`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-sse-mock-mode`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sse-protocol-registry`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-sse-type-safe-events`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-mfe-entry-types`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-mfe-ext-domain`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-mfe-shared-property`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-mfe-action-types`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-mfe-dynamic-registration`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-mfe-theme-propagation`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-mfe-i18n-propagation`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-blob-fresh-eval`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-blob-no-revoke`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-blob-source-cache`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-blob-import-rewriting`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-blob-recursive-chain`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-blob-per-load-map`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-externalize-transform`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-externalize-filenames`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-externalize-build-only`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-dataflow-internal-app`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-dataflow-no-redux`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-sharescope-construction`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-sharescope-concurrent`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-broadcast-write-api`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-broadcast-matching`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-broadcast-validate`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-validation-gts`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-validation-reject`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-i18n-formatters`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-i18n-formatter-exports`
...
- [ ] `p2` - **ID**: `cpt-hai3-fr-i18n-graceful-invalid`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-i18n-hybrid-namespace`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-i18n-lazy-chunks`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-uikit-react19-ref`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-uikit-layout`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-uikit-toast-hook`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-studio-panel`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-studio-controls`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-studio-persistence`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-studio-viewport`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-studio-independence`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-cli-commands`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-cli-templates`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-pub-metadata`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-pub-versions`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-perf-lazy-loading`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-perf-treeshake`
...
- [ ] `p2` - **ID**: `cpt-hai3-nfr-perf-blob-overhead`
...
- [ ] `p2` - **ID**: `cpt-hai3-nfr-perf-action-timeout`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-rel-error-handling`
...
- [ ] `p2` - **ID**: `cpt-hai3-nfr-rel-api-retry`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-rel-serialization`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-sec-shadow-dom`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-sec-csp-blob`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-sec-type-validation`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-compat-node`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-compat-typescript`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-compat-react`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-maint-zero-crossdeps`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-maint-event-driven`
...
- [ ] `p2` - **ID**: `cpt-hai3-nfr-maint-arch-enforcement`
...
- [ ] `p1` - **ID**: `cpt-hai3-interface-state`
...
- [ ] `p1` - **ID**: `cpt-hai3-interface-screensets`
...
- [ ] `p1` - **ID**: `cpt-hai3-interface-framework`
...
- [ ] `p1` - **ID**: `cpt-hai3-interface-react`
...
- [ ] `p1` - **ID**: `cpt-hai3-interface-uikit`
...
- [ ] `p2` - **ID**: `cpt-hai3-interface-studio`
...
- [ ] `p1` - **ID**: `cpt-hai3-contract-mfe-manifest`
...
- [ ] `p2` - **ID**: `cpt-hai3-contract-federation-runtime`
...
- [ ] `p1` - **ID**: `cpt-hai3-usecase-mfe-load`
...
- [ ] `p2` - **ID**: `cpt-hai3-usecase-scaffold`
...
- [ ] All 10 packages build successfully in layer dependency order
- [ ] `npm run arch:check` passes with zero violations (dependency-cruiser)
- [ ] `npm run arch:unused` passes with zero violations (Knip)
- [ ] SDK packages (state, screensets, api, i18n) have zero `@hai3/*` dependencies
- [ ] MFE blob URL isolation produces independent module evaluations per load
- [ ] Shared property updates propagate only to domains that declare the property
- [ ] GTS validation rejects invalid shared property values before propagation
- [ ] All formatters return `''` for invalid inputs without throwing
- [ ] Studio panel is excluded from production builds via tree-shaking
- [ ] CLI scaffolds functional project with `hai3 create` + `hai3 scaffold layout`
