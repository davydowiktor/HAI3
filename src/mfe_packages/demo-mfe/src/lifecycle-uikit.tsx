 ...
 * to UIKitElementsScreen. The bridge is passed through as a prop for
 ...
 */
class UIKitElementsLifecycle implements MfeEntryLifecycle<ChildMfeBridge> {
  ...
  mount(container: Element, bridge: ChildMfeBridge): void {
    ...
    this.root.render(<UIKitElementsScreen bridge={bridge} />);
  }
