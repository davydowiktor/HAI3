 ...
 * to CurrentThemeScreen. The bridge is passed through as a prop for
 ...
 */
class CurrentThemeLifecycle implements MfeEntryLifecycle<ChildMfeBridge> {
  ...
  mount(container: Element, bridge: ChildMfeBridge): void {
    ...
    this.root.render(<CurrentThemeScreen bridge={bridge} />);
  }
